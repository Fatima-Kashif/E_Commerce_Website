                  ...
                  <div className="min-w-[200px]">
                    ...
                    <form className="flex items-center">
                      <input
                        ...
                        className="border-b border-black focus:outline-none flex-grow py-1 text-sm min-w-0"
                      />
                      <button type="submit" className="text-black font-semibold ml-2 hover:text-gray-600 border-b py-1 border-black whitespace-nowrap">
                        SUBSCRIBE
                      </button>
                    </form>
                  </div>
