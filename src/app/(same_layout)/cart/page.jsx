...
<p >Cart</p>
            ...
            <div className="flex items-center mt-20 gap-2 w-[100%] ">
                <img src="cart_sofa.png" alt="cart_img" className="rounded ml-20 " />
                <p className="text-[#9F9F9F]">Asgaard Sofa</p>
                <p className="text-[#9F9F9F] ml-6">Rs. 250,000.00</p>
                <div className="h-8 w-8 rounded border-2 text-center ml-14">1</div>
                <p className="ml-[70px]">Rs. 250,000.00</p>
...
<div className="bg-[#F9F1E7] w-[30%] h-[50%] p-5 mt-20  ">
    ...
    <div className="flex flex-col gap-8 justify-center items-center">
        <p className="mt-20">Subtotal <span className="text-[#9F9F9F] ml-10 ">Rs. 250,000.00</span></p>
        <p>Total <span className="text-[#B88E2F] text-lg ml-14">Rs. 250,000.00</span></p>
