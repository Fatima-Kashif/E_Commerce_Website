            ...
            <div className="flex gap-20 mb-60">
                ...
                <div className="bg-[#F9F1E7] w-[30%] h-[50%] p-5 mt-20">
                    ...
                    <div className="flex flex-col gap-8 justify-center items-center">
                        <p className="mt-20">Subtotal <span className="text-[#9F9F9F] ml-10">Rs. {subtotal.toLocaleString()}</span></p>
                        <p>Total <span className="text-[#B88E2F] text-lg ml-14">Rs. {subtotal.toLocaleString()}</span></p>
                        <Link href="/checkout">
