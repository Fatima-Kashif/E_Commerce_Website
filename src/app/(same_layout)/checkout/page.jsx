  ...
  return (
    <div className="font-custom p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-2xl sm:text-4xl mt-10 font-semibold">Billing Details</h2>
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            ...
            <input
              type="text"
              className="mt-2 w-full border-2 p-4 rounded-lg"
            />
          </div>
          <div>
          ...
          <div className="col-span-1 sm:col-span-2">
            ...
            <select
              className="mt-2 w-full border-2 p-4 rounded-lg text-gray-500"
            >
        ...
        <div className="mt-12 bg-white shadow-lg rounded-lg p-6">
          <div className="border-b pb-4">
            <div className="flex justify-between font-semibold text-lg sm:text-2xl">
              <span>Product</span>
              <span>Subtotal</span>
            </div>
            <div className="mt-4 flex justify-between">
            ...
            <div className="mt-6 flex justify-between">
              <span>Total</span>
              <span className="text-yellow-600 text-lg sm:text-2xl font-bold">
                Rs. 250,000.00
              </span>
            </div>
          </div>
          ...
          <p className="mt-6 text-sm text-gray-600">
            ...
            other purposes described in our <a href="#" className="font-bold">privacy policy</a>.
          </p>

          <div className="flex justify-center mt-6">
            <button className="w-full sm:w-auto px-12 py-4 border-2 text-black border-black rounded-xl hover:bg-black hover:text-white transition">
              Place order
            </button>
          </div>
        </div>
